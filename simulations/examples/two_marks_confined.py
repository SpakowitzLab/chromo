"""Run a confined simulation with two epigenetic marks.

By:         Joseph Wakim
Group:      Spakowitz Lab @ Stanford
Date:       23 October 2023

Usage:  python two_marks_confined.py <CONFIG_FILE_PATH>
...
if "confine_length" in config:
    confine_length = float(config["confine_length"])
else:
