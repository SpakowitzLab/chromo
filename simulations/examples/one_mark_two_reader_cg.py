...
Usage:      `python one_mark_two_reader_cg.py <CP_HP1> <CP_PRC1> <J_HP1,HP1> <J_PRC1,PRC1> <J_HP1,PRC1> <CG_FACTOR> <OPTIONAL_RANDOM_SEED>`
"""
...
# Remove the second epigenetic mark!
chemical_mods[:, 1] = 0
