...
Usage:      `python two_mark_cg.py <CP_HP1> <CP_PRC1> <J_HP1,HP1> <J_PRC1,PRC1> <J_HP1,PRC1> <CG_FACTOR> <mark_2_path> <OPTIONAL_RANDOM_SEED>`
"""
...
# Load the pattern for the second epigenetic mark
mark_2_pattern_path = str(sys.argv[7])
...
chem_mods_path = np.array([
    "chromo/chemical_mods/HNCFF683HCZ_H3K9me3_0p5.txt",
    mark_2_pattern_path
])
