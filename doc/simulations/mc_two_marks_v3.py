...
self_interaction_HP1 = float(sys.argv[2])
...
chem_mods_path = np.array(
    [
        "chromo/chemical_mods/HNCFF683HCZ_H3K9me3_methyl_393216.txt",
        "chromo/chemical_mods/ENCFF919DOR_H3K27me3_methyl_393216.txt"
    ]
)
chemical_mods_all = Chromatin.load_seqs(chem_mods_path)

# Filter to the domain with lowest correlation between marks
ind_start = 262145
ind_end = 312145
chemical_mods = chemical_mods_all[ind_start:ind_end]
