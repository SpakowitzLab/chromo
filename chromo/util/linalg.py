...
def arbitrary_axis_rotation(r_ind0, r_ind1, rot_angle):
    ...
    full_length = math.sqrt(r_ind0[0]**2 + r_ind0[1]**2 + r_ind0[2]**2)
    ...
    if not np.isclose(proj_len_yz, 0):
        rot_mat_y[0, 0] = proj_len_yz / full_length
        rot_mat_y[0, 2] = -r_ind0[0] / full_length
        rot_mat_y[2, 0] = r_ind0[0] / full_length
        rot_mat_y[2, 2] = proj_len_yz / full_length
    inv_rot_mat_y = rot_mat_y.copy()
